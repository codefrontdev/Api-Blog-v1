    ...
    return ( 
        <section className="post-details">
            <div className="post-details-image-wrapper">
                ...
                {user?._id === post?.user?._id && (
                    <form onSubmit={updateImageSubmitHandler} className="update-post-image-form">
                        <label className='update-post-label' htmlFor="file">
            ...
            <p className="post-details-description">
                ...
                Vel delectus voluptas et quia illo quam repellendus deleniti. 
                Maiores praesentium blanditiis dolorem aperiam voluptatum. Error, 
                velit optio natus corrupti earum debitis?
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                Vel delectus voluptas et quia illo quam repellendus deleniti. 
                Maiores praesentium blanditiis dolorem aperiam voluptatum. Error, 
                velit optio natus corrupti earum debitis?
